...
class __TwigTemplate_55184938ba5e167c6084cd22a6f31b78acbc0c01b7f503634cbc3dac59797795 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
            // line 24
            echo $this->extensions['Drupal\twig_extender\TwigExtenderService']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["children"] ?? null), 24, $this->source), "html", null, true);
            echo "
  </div>
";
        }
